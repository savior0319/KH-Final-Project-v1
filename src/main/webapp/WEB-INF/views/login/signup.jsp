						...
						<thead>
							<tr>
								<th><span style="color:red; margin-left: 15px; font-size: 15px; margin-bottom: 0px; margin-top: 0px;">*</span> 계정<div style="font-size: 12px;">(이메일 주소)</div>
									<td>
										<div class="ui form">
											<input type="text" name="mbId" id="mbId" placeholder="이메일 주소입력" required>
								...
								<tr>
									<th><span style="color:red; margin-left: 15px; font-size: 15px; margin-bottom: 0px; margin-top: 0px;">*</span> 닉네임<div style="font-size: 12px;">(한글 2~5글자)</div>
										<td>
											<div class="ui form">
												<input type="text" name="mbNickName" id="mbNickName" placeholder="닉네임 입력" required>
											</div>
										</td>
									</tr>
									<tr>
										<th><span style="color:red; margin-left: 15px; font-size: 15px; margin-bottom: 0px; margin-top: 0px;">*</span> 비밀번호<div style="font-size: 12px;">(영대소문자 및 숫자를 포함한 6~16자리)</div>
