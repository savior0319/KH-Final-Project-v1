   ...
   <div class="ui container">
      <div class="ui center aligned basic segment">
         ...
         <div align="left" style="margin-bottom: 8px;">
            <div align="left">
               ※ 목표기간  <span style="color: rgb(250,40,40);">'${bmr.period}' 개월</span><br>
               ※ 한달 동안 감량해야 할 몸무게 <span style="color: rgb(250,40,40);">'${bmr.periodUnit}' kg</span><br>
            </div>
            <br>
            <hr>
            <br>
