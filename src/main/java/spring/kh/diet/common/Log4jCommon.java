...
/*	// 서비스용 After
	...
	// 컨트롤러용 Before
	@Pointcut("execution(* spring.kh.diet.controller.DietTipControllerImpl.*(*)) || execution(* spring.kh.diet.controller.HomeTrainingControllerImpl.*(*))|| execution(* spring.kh.diet.controller.*Impl.*(*))"
			+ "execution(* spring.kh.diet.model.service.DietTipServiceImpl.*(*)) || execution(* spring.kh.diet.model.service.HomeTrainingServiceImpl.*(*))|| execution(* spring.kh.diet.model.service.*Impl.*(*))"
			+ "execution(* spring.kh.diet.model.dao.DietTipDAOImpl.*(*)) || execution(* spring.kh.diet.model.dao.HomeTrainingDAOImpl.*(*))|| execution(* spring.kh.diet.model.dao.*Impl.*(*))")
