...
//		System.out.println(DietTipControllerImpl.class.getResource("/../..").getPath());
	...
	@Override
	@RequestMapping(value = "/getDietTipMainPhotoPath.diet")
	public void getDietTipMainPhotoPath(HttpSession session, HttpServletRequest request, HttpServletResponse response, MultipartFile file) throws IOException{
		...
		String getFile = ((MultipartFile)req).getOriginalFilename();
